      ...
      <ul class="sidebar-nav nav-pills nav-stacked" id="menu">
        ...
        <li>
          ...
          <ul class="nav-pills nav-stacked" style="list-style-type:none;">
            ...
            <li><a href="{{ url('/penilaian_siswa/create') }}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span>Buat Penilaian</a></li>
            <li><a href="{{ url('/penilaian_siswa/check') }}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span>Check Jawaban Siswa</a></li>

            <li><a href="{{ url('/bobot_soal') }}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span>Bobot Soal</a></li>
            <li><a href="{{ url('/penjurusan') }}"><span class="fa-stack fa-lg pull-left"><i class="fa fa-flag fa-stack-1x "></i></span>Penjurusan</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /#sidebar-wrapper -->

...
<div class="form-group {{ $errors->has('Alamat') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6 required">
        {!! Form::text('JenisKelamin', null, ['class' => 'form-control required']) !!}
    ...
    <div class="col-md-6 required">
        {!! Form::text('TempatLahir', null, ['class' => 'form-control required']) !!}
    ...
    <div class="col-md-6 required">
        {!! Form::text('NoKtp', null, ['class' => 'form-control required']) !!}
